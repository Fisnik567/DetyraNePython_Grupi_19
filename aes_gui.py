...
tab_control.add(tab1, text=f'{"AES 128-bit encryption":^20s}')
tab_control.add(tab2, text=f'{"AES 192-bit encryption":^20s}')
...
buttonECB111 = Button(tab3, text="ECB 256-bit Encryption", width=12, bg="#03A9F4", fg = "#fff")
buttonECB111.place(x=50,y=100)
buttonECB111.bind("<Button-1>", shenoFjalen5)
buttonECB111.configure(height=1, width=18)

buttonCFB111 = Button(tab3, text="CFB 256-bit Encryption", width=12, bg="#03A9F4", fg = "#fff")
